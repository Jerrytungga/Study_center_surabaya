                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-body">Data Kontakan  <a href="kontakan.php">
                                    <span class="badge bg-danger">           
                                        <?php
                                            $total_kontakan = mysqli_query($conn,"SELECT COUNT(id_kontakan) as total FROM `data_kontakan`");
                                            $jumlah = mysqli_fetch_array($total_kontakan);
                                            echo $jumlah['total'];
                                        ?></span> </a>
                                </div>
